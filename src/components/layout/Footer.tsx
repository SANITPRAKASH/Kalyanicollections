        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-display text-xl font-bold">Kalyani Collections</span>
            </Link>
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:info@kalyanicollections.com" className="text-gray-300 hover:text-primary-300 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300 text-sm">+91 9964742910</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-4 h-4 text-primary-300" />
                <span className="text-gray-300 text-sm">info@kalyanicollections.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © 2025 Kalyani Collections. All rights reserved.
            </p>
